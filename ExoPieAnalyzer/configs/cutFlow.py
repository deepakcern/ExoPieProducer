class cutFlow:
    def __init__(self,nEle_loose,nEle_tight,nMu_loose,nMu_tight,nTau,Werecoil,Wmurecoil,ZeeRecoil,ZmumuRecoil,pfMet,njets,njets_iso,nBjets,nBjets_iso,h_mass,nAK8JetsSR,nAK8JetsSBand,nAK8JetsZCR,ZeeMass,ZmumuMass):
    ...
    def singleLepton_R(self,value,isEleRegion=True,isTop=True):
        ...
        if isEleRegion:
            ...
            bin2 = bin1 and self.nMu_loose==0 and self.nTau==0
