...
df_out_ZeeCR_1b = DataFrame(columns=['run','lumi','event','MET','METPhi','Recoil','RecoilPhi','Zmass','ZpT','nPV',
                                  ...
                                  'weight','weightRecoil','weightEle','weightMu','weightB','weightEWK','weightQCD','weightTop','weightPU','weightRecoil_up','weightEle_up','weightMu_up','weightB_up','weightEWK_up','weightQCD_up','weightTop_up','weightPU_up','weightJEC_up','Recoil_Res_up','Recoil_En_up','Recoil_En_down','Recoil_Res_down','weightJEC_down','weightRecoil_down','weightEle_down','weightMu_down','weightB_down','weightEWK_down','weightQCD_down','weightTop_down','weightPU_down'])
