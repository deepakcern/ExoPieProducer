...
df_out_SR_1b = DataFrame(columns=['run','lumi','event','MET','nPV',
                                  ...
                                  'weight','weightMET','weightEle','weightMu','weightB','weightEWK','weightQCD','weightTop','weightPU','weightMET_up','weightEle_up','weightMu_up','weightB_up','weightEWK_up','weightQCD_up','weightTop_up','weightPU_up','weightJEC_up','weightMETres_up','weightMETEn_up','weightMETEn_down','weightMETres_down','weightJEC_down','weightMET_down','weightEle_down','weightMu_down','weightB_down','weightEWK_down','weightQCD_down','weightTop_down','weightPU_down'])
...
df_out_ZeeCR_1b = DataFrame(columns=['run','lumi','event','MET','Recoil','Zmass','ZpT','nPV',
                                  ...
                                  'weight','weightRecoil','weightEle','weightMu','weightB','weightEWK','weightQCD','weightTop','weightPU','weightRecoil_up','weightEle_up','weightMu_up','weightB_up','weightEWK_up','weightQCD_up','weightTop_up','weightPU_up','weightJEC_up','weightRecoilres_up','weightRecoilEn_up','weightRecoilEn_down','weightRecoilres_down','weightJEC_down','weightRecoil_down','weightEle_down','weightMu_down','weightB_down','weightEWK_down','weightQCD_down','weightTop_down','weightPU_down'])
