...
def runbbdm(txtfile):
    ...
    for df in read_root(filename, 'outTree', columns=var.allvars_bbDM, chunksize=125000):
        ...
        in zip(df.st_runId, df.st_lumiSection, df.st_eventId, \
            ...
            weightB_up =  weightEWK_up =  weightQCD_up =  weightTop_up = weightJEC_up = weightEleTrig_up =  weightEle_up =  weightMu_up =  weightMET_up =  weightRecoil_up = weightPU_up = weightJEC_up = weightMETres_up = weightMETEn_up = weightRecoilres_up = weightRecoilEn_up =  1.0
            weightB_down =  weightEWK_down =  weightQCD_down =  weightTop_down = weightJEC_down = weightEleTrig_down =  weightEle_down =  weightMu_down =  weightMET_down =  weightRecoil_down = weightPU_down = weightJEC_down = weightMETres_down = weightMETEn_down = weightRecoilres_down = weightRecoilEn_down =  1.0
            if ep_isData:
                ...
                weightEWK_up = wgt.getEWKZ(ep_genParPt[1]); weightQCD_up = wgt.getQCDZ(ep_genParPt[1])
                weightEWK_down = wgt.getEWKZ(ep_genParPt[2]); weightQCD_down = wgt.getQCDZ(ep_genParPt[2])
