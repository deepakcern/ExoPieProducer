...
def runbbdm(txtfile):
    ...
    h_reg_SR_1b_cutFlow.SetEntries(5)
    h_reg_SR_2b_cutFlow.SetEntries(5)
    h_reg_ZeeCR_1b_cutFlow.SetEntries(6)
    h_reg_ZeeCR_2b_cutFlow.SetEntries(6)
    h_reg_ZmumuCR_1b_cutFlow.SetEntries(6)
    h_reg_ZmumuCR_2b_cutFlow.SetEntries(6)
    h_reg_WenuCR_1b_cutFlow.SetEntries(6)
    h_reg_WenuCR_2b_cutFlow.SetEntries(6)
    h_reg_WmunuCR_1b_cutFlow.SetEntries(6)
    h_reg_WmunuCR_2b_cutFlow.SetEntries(6)
    h_reg_TopenuCR_1b_cutFlow.SetEntries(6)
    h_reg_TopenuCR_2b_cutFlow.SetEntries(6)
    h_reg_TopmunuCR_1b_cutFlow.SetEntries(6)
    h_reg_TopmunuCR_2b_cutFlow.SetEntries(6)
