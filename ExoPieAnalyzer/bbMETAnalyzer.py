...
def runbbdm(txtfile):
    ...
    for df in read_root(filename, 'outTree', columns=var.allvars_bbDM, chunksize=125000):
        for ep_runId, ep_lumiSection, ep_eventId, \
            ...
            if era == '2016':
                ep_THINbjets_index = [ij for ij in range(ep_THINnJet) if (
                    ep_THINjetDeepCSV[ij] > deepCSV_Med and abs(ep_THINjetEta[ij]) < 2.4)]
            else:
                ep_THINbjets_index = [ij for ij in range(ep_THINnJet) if (
                    ep_THINjetDeepCSV[ij] > deepCSV_Med and abs(ep_THINjetEta[ij]) < 2.5)]
                           ...
                           if (ep_THINnJet <= 2) and (ep_THINjetPt[0] > 50.):
                               ...
                               if (ep_THINjetDeepCSV[0] > deepCSV_Med) and (nBjets == 1):
                                   ...
                                   if ep_THINnJet == 2:
                                       ...
                                       dEtaJet12 = (
                                           ep_THINjetEta[0]-ep_THINjetEta[1])
                                       M_Jet1Jet2 = InvMass(ep_THINjetPx[0], ep_THINjetPy[0], ep_THINjetPz[0], ep_THINjetEnergy[0],
                           ...
                           if (ep_THINnJet <= 3 and ep_THINnJet > 1) and (ep_THINjetPt[0] > 50.):
                               ...
                               if (ep_THINjetDeepCSV[0] > deepCSV_Med) and (ep_THINjetDeepCSV[1] > deepCSV_Med) and (nBjets == 2):
                                   ...
                                   if ep_THINnJet == 3:
                                       ...
                                       M_Jet1Jet3 = InvMass(ep_THINjetPx[0], ep_THINjetPy[0], ep_THINjetPz[0], ep_THINjetEnergy[0],
                                                            ep_THINjetPx[2], ep_THINjetPy[2], ep_THINjetPz[2], ep_THINjetEnergy[2])
    ...
    df_out_TopmunuCR_1b.to_root(
        outfilenameis, key='bbDM_TopmunuCR_1b', mode='a')
    df_out_TopmunuCR_2b.to_root(
        outfilenameis, key='bbDM_TopmunuCR_2b', mode='a')
