...
def VarToHist(df_var,df_weight,df_weight_den,df_weight_num,HISTNAME,binning):
    ...
    #if ApplyBWeight : print 'btagging weight is getting applied on this sample'
    #for ij, value in enumerate(df_var):
    #for ij in range(len(df_var)):
    #for value, weight in zip(df_var,df_weight):
	...
	#if ApplyBWeight:h_var.Fill(value, weight*btagweight)
        #else:
...
def HistWrtter(df, outfilename, treeName,mode="UPDATE"):
    ...
    if 'SBand' in reg or 'SR' in reg:
        ...
        h_list.append(VarToHist(df["N2DDT"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_N2DDT",[40,-0.5,0.5]))
        h_list.append(VarToHist(df["FJetN2b1"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetN2b1",[40,-0.5,0.5]))
        ...
        h_list.append(VarToHist(df["FJetPt"], df["weight"],df["weight"],df["weight"], "h_reg_"+reg+"_FJetPt",[50,200,1000]))
        h_list.append(VarToHist(df["FJetMass"], df["weight"],df["weight"],df["weight"],"h_reg_"+reg+"_FJetMass",[100,0,500]))#FJetMass
        h_list.append(VarToHist(df["FJetEta"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetEta",[20,-2.5,2.5]))
        h_list.append(VarToHist(df["FJetPhi"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetPhi",[20,-3.14,3.14]))
        h_list.append(VarToHist(df["FJetCSV"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetCSV",[30,0,1]))
        h_list.append(VarToHist(df["nJets"],   df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_nJets",[10,0,10]))
        h_list.append(VarToHist(df["min_dPhi"],df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_min_dPhi",[20,0,4]))#mini_dPhi)   min_dphi_jets
        h_list.append(VarToHist(df["min_dphi_jets"],df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_min_dphi_jets",[20,0,4]))
        ...
        h_list.append(VarToHist(df["FJetPt"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetPt",[15,200,1000]))
        h_list.append(VarToHist(df["FJetMass"], df["weight"],df["weight"],df["weight"],"h_reg_"+reg+"_FJetMass",[100,0,500]))#FJetMass
        h_list.append(VarToHist(df["FJetEta"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetEta",[20,-2.5,2.5]))
        h_list.append(VarToHist(df["FJetPhi"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetPhi",[20,-3.14,3.14]))
        h_list.append(VarToHist(df["FJetCSV"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_FJetCSV",[30,0,1]))
        h_list.append(VarToHist(df["Jet1Pt"],  df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_Jet1Pt",[15,30,500]))
        h_list.append(VarToHist(df["Jet1Eta"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_Jet1Eta",[20,-4.5,4.5]))
        h_list.append(VarToHist(df["Jet1Phi"], df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_Jet1Phi",[20,-3.14,3.14]))
        h_list.append(VarToHist(df["nJets"],   df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_nJets",[10,0,10]))
        h_list.append(VarToHist(df["min_dPhi"],   df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_min_dPhi",[20,0,4]))#mini_dPhi)
        h_list.append(VarToHist(df["met_Phi"],   df["weight"], df["weight"],df["weight"],"h_reg_"+reg+"_met_Phi",[20,-3.14,3.14]))
...
def emptyHistWritter(treeName,outfilename,mode="UPDATE"):
    ...
    if 'SBand' in reg or 'SR' in reg:
        ...
        h_list.append(SetHist("h_reg_"+reg+"_N2DDT",[40,-0.5,0.5]))
        h_list.append(SetHist("h_reg_"+reg+"_FJetN2b1",[40,-0.5,0.5]))
        ...
        h_list.append(SetHist("h_reg_"+reg+"_FJetMass",[100,0,500]))#FJetMass
        h_list.append(SetHist("h_reg_"+reg+"_FJetEta",[20,-2.5,2.5]))
        h_list.append(SetHist("h_reg_"+reg+"_FJetPhi",[20,-3.14,3.14]))
        h_list.append(SetHist("h_reg_"+reg+"_FJetCSV",[30,0,1]))
        h_list.append(SetHist("h_reg_"+reg+"_nJets",[10,0,10]))
        h_list.append(SetHist("h_reg_"+reg+"_min_dPhi",[20,0,4]))#mini_dPhi)   min_dphi_jets
        h_list.append(SetHist("h_reg_"+reg+"_min_dphi_jets",[20,0,4]))
    else:
        ...
        h_list.append(SetHist("h_reg_"+reg+"_FJetPhi",[20,-3.14,3.14]))
        h_list.append(SetHist("h_reg_"+reg+"_FJetCSV",[30,0,1]))
        h_list.append(SetHist("h_reg_"+reg+"_Jet1Pt",[15,30,500]))
        h_list.append(SetHist("h_reg_"+reg+"_Jet1Eta",[20,-4.5,4.5]))
        h_list.append(SetHist("h_reg_"+reg+"_Jet1Phi",[20,-3.14,3.14]))
        h_list.append(SetHist("h_reg_"+reg+"_nJets",[10,0,10]))
        h_list.append(SetHist("h_reg_"+reg+"_min_dPhi",[20,0,4]))#mini_dPhi)
        h_list.append(SetHist("h_reg_"+reg+"_met_Phi",[20,-3.14,3.14]))
...
trees =['monoHbb_SR_boosted','monoHbb_Tope_boosted','monoHbb_Topmu_boosted','monoHbb_We_boosted','monoHbb_Wmu_boosted','monoHbb_Zmumu_boosted','monoHbb_Zee_boosted','monoHbb_SBand_boosted']
...
def runFile(filename):#,trees):
    ...
    for index, tree in enumerate(trees):
	    ...
	    #	df = df[df.N2DDT < 0.0] 
      	    #	df = df[df.N2DDT > -1]
	    if 'Zee' in tree or 'Zmumu' in tree:
                df = df[df.FJetMass > 50.0]
                df = df[df.FJetMass < 150.0]
